...
const icons: Record<string, (size: number) => ReactNode> = {
  ...
  'star-badge': (s) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 15l-3.09 1.636.59-3.444-2.5-2.44 3.454-.502L12 7.25l1.545 3 3.455.502-2.5 2.44.59 3.444z" />
  ...
  spine: (s) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2v0a3 3 0 0 1 0 6v0a3 3 0 0 1 0 6v0a3 3 0 0 1 0 6v0" />
      <path d="M8 5h8" />
      <path d="M8 11h8" />
      <path d="M8 17h8" />
      <path d="M12 20v2" />
  ...
  'leaf-plate': (s) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 20A7 7 0 0 1 9.8 6.9C15.5 4.9 17 3.5 17 3.5s1.5 2.5-.5 6.5c-1.2 2.4-3.5 4-6.5 5" />
      <path d="M11.7 13.5c2-1.7 3.7-3.5 4.5-5.5" />
  ...
  meditation: (s) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 7v3" />
      <path d="M8 14c-2 0-3 1-3 3h14c0-2-1-3-3-3" />
