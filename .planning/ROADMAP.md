...
- [ ] **Phase 1: Gamification Core** - XP engine, achievements, PR detection, streak enhancement, and localStorage schema migration — zero external dependencies
...
|-------|----------------|--------|-----------|
| 1. Gamification Core | 2/6 | In progress | - |
